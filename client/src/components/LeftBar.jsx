...
const LeftBar = () => {
  ...
  return (
    ...
    >
      <div
        className="border-b-2 min-h-[50px] border-white/10 flex w-full justify-between px-4 text-2xl items-center text-white/75 font-medium"
      ...
      >
        ...
        <div className="flex gap-2 "><Link to={"/profile"}>
          <LuUserRoundPlus className="text-xl cursor-pointer hover:text-white transition-all duration-200" />
          </Link><Link to={"/settings"}><LuBolt className="text-xl cursor-pointer hover:text-white transition-all duration-200" />
        </Link></div>
      </div>
